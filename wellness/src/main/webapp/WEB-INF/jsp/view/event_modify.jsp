...
<link rel="stylesheet" type="text/css" href="${root }/css/event_modify.css">
<meta charset="UTF-8">
...
<div class="gallery_wirte_wrap">
	...
	<input type="hidden" name="event_homepage_idx" value="${evo.event_homepage_idx }">
		...
		<table class="gw_form_table">
			<tbody>
				<tr>
					<td>제목</td>
					<td>
						<div class="sctd_div"><input type="text" name="event_homepage_title" placeholder="제목을 입력해주세요." required value="${evo.event_homepage_title }"></div>
					</td>
				</tr>
				<tr>
					<td>내용</td>
					<td>
						<div class="sctd_div sctd_div2"><textarea name="event_homepage_content" placeholder="내용을 입력해주세요." required>${evo.event_homepage_content }</textarea></div>
					</td>
				</tr>
				<tr>
					<td>이벤트<br>기간</td>
					<td>
						<div class="sctd_div sctd_div4">
							<div style="margin-bottom: 10px;font-size: 13px;color: #707070;">시작일<input required="required" style="margin-left: 10px;" type="date" name="event_homepage_start_date" value="${evo.event_homepage_start_date }"></div>
							<div style="font-size: 13px;color: #707070;">종료일<input required="required" style="margin-left: 10px;" type="date" name="event_homepage_end_date" value="${evo.event_homepage_end_date }"></div>
						</div>
					</td>
				</tr>
				<tr>
...
<!-- 									<button id="video_btn" onclick="openVFile(event)"></button><input type="file" id="v_file" name="v_file" multiple="multiple" onchange="fileUpload(event)"> -->
									<button id="img_btn" onclick="openIFile(event)"></button><input accept="image/*" type="file" id="i_file" name="i_file" onchange="fileUpload(event)">
									<script>
				...
				<tr>
					...
					<td>
						<div class="show_file_list">
							<p class="p_file">${imgVO.img_path }</p>
						</div>
