...
<link rel="stylesheet" type="text/css" href="${root }/css/event_wellness_modify.css">
<meta charset="UTF-8">
...
<div class="gallery_wirte_wrap">
	...
	<input type="hidden" name="event_wellness_idx" value="${e_wvo.event_wellness_idx }">
		...
		<table class="gw_form_table">
			<tbody>
				<tr>
					<td>제목</td>
					<td>
						<div class="sctd_div"><input type="text" name="event_wellness_title" placeholder="제목을 입력해주세요." required value="${e_wvo.event_wellness_title }"></div>
					</td>
				</tr>
				<tr>
					<td>내용</td>
					<td>
						<div class="sctd_div sctd_div2"><textarea name="event_wellness_content" placeholder="내용을 입력해주세요." required>${e_wvo.event_wellness_content }</textarea></div>
					</td>
				</tr>
				<tr>
					<td>첨부</td>
